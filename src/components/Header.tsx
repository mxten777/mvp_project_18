      ...
      >
        <div className="flex w-full md:w-auto items-center justify-between">
          ...
          <div className="block md:hidden">
            {!menuOpen && (
              <button
                className="p-3 ml-2 rounded-full bg-white/90 shadow border border-green-200 text-3xl font-extrabold text-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 active:bg-green-50 transition-all duration-150"
                aria-label="메뉴 열기"
