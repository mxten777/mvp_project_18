...
const Hero: React.FC = () => (
  <section className="relative py-20 md:py-28 bg-gradient-to-br from-green-50 via-white to-green-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-800 flex flex-col items-center justify-center overflow-hidden rounded-2xl shadow-xl mx-2 mt-6">
  ...
  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-green-200 to-green-100 dark:from-gray-800 dark:to-gray-700 shadow-lg mb-6 border-4 border-white dark:border-gray-700">
  ...
  <h2
    className="text-2xl md:text-5xl font-extrabold text-green-700 dark:text-gray-100 mb-4 drop-shadow-sm tracking-tight leading-snug md:leading-relaxed select-none text-center"
  ...
  <p className="text-xl md:text-2xl text-green-600 dark:text-gray-300 mb-8 font-medium drop-shadow-sm">국가 지원금 85% 이상, 전화 한 통으로 통합 방문요양/간호/목욕 서비스</p>
      <Button
        size="lg"
        aria-label="상담신청 바로가기"
        onClick={() => window.location.href = "/apply"}
        className="flex items-center gap-2 px-7 py-3 rounded-xl bg-green-500 dark:bg-gray-700 hover:bg-green-600 dark:hover:bg-gray-600 active:bg-green-700 dark:active:bg-gray-800 text-white dark:text-gray-100 font-bold text-lg shadow-md transition focus:outline-none focus:ring-2 focus:ring-green-400 dark:focus:ring-gray-400 focus:ring-offset-2"
        style={{fontFamily:'Pretendard,Noto Sans KR,sans-serif'}}
      >
